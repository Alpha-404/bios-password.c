CC = gcc
CFLAGS = -O0 -g -Wall -DENABLE_SONY -DENABLE_HPMINI -DENABLE_PHOENIX -DENABLE_HPAMI -DENABLE_INSYDE -DENABLE_ASUS -DENABLE_DELL # add -O2 for optim, add -O0 -g for debug
LDFLAGS = -lm
